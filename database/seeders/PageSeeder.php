    ...
    public function run(): void
    {
        $pages = [
            ...
            [
                ...
                'meta_title' => 'Frequently Asked Questions | E-Club Store Help',
            ...
            [
                ...
                'slug' => 'warranty',
                'content' => '<p>All our e-club comes with comprehensive warranty coverage.</p><h2>Standard Warranty</h2><p>2-year warranty on all e-club covering manufacturing defects.</p><h2>Premium Warranty</h2><p>5-year extended warranty on premium collections.</p><h2>What\'s Covered</h2><ul><li>Manufacturing defects</li><li>Structural failures</li><li>Hardware malfunctions</li></ul>',
                'meta_title' => 'Warranty Information | 2-Year Coverage',
                'meta_description' => 'All e-club includes 2-year warranty against manufacturing defects. Premium collections have 5-year extended warranty.',
                'is_active' => true,
                'sort_order' => 6,
            ],
            [
                ...
                'slug' => 'care',
                'content' => '<p>Proper care extends the life and beauty of your e-club.</p><h2>Wood E-Club</h2><ul><li>Dust regularly with soft cloth</li><li>Avoid direct sunlight</li><li>Use coasters for drinks</li></ul><h2>Upholstery</h2><ul><li>Vacuum regularly</li><li>Rotate cushions monthly</li><li>Clean spills immediately</li></ul>',
                'meta_title' => 'E-Club Care & Maintenance Guide',
                'meta_description' => 'Expert tips to keep your e-club looking its best. Learn how to care for wood, upholstery, and leather.',
                'is_active' => true,
                'sort_order' => 7,
            ],
            [
                'title' => 'Store Locator',
                'slug' => 'stores',
                'content' => '<p>Visit one of our showrooms to experience our e-club in person.</p><h2>Dhaka Showrooms</h2><p>Dhanmondi, Gulshan, Uttara, Mirpur</p><h2>Regional Showrooms</h2><p>Chittagong, Sylhet</p>',
                'meta_title' => 'Store Locator | Find a Showroom Near You',
                'meta_description' => 'Find our e-club showrooms across Bangladesh. Visit us in Dhaka, Chittagong, Sylhet, and more.',
                'is_active' => true,
                'sort_order' => 8,
            ],
        ];
