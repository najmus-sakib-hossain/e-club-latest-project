                    ...
                    <div className="max-w-4xl mx-auto prose prose-lg">
                        {termsContent ? (
                            ...
                            <>
                                ...
                                <h3>Pricing</h3>
                                <ul>
                                    <li>All prices are in Bangladeshi Taka (BDT) and include VAT</li>
                                ...
                                <ul>
                                    ...
                                    <li>We accept cash on delivery, bKash, Nagad, and major credit cards</li>
                                    <li>Payment information is processed securely through trusted providers</li>
                                    <li>We are not liable for third-party payment processing issues</li>
                                </ul>

                                <h2>4. Delivery</h2>
                                <ul>
                                    <li>Delivery times are estimates and not guaranteed</li>
                                    <li>Delays may occur due to circumstances beyond our control</li>
                                ...
                                <ul>
                                    <li>7-day return window for items in original condition</li>
                                    <li>Manufacturing defects reported within 30 days qualify for refund</li>
                                    <li>Custom-made and personalized items cannot be returned</li>
                                ...
                                <h2>6. Warranty</h2>
                                <ul>
                                    <li>All products come with a 2-year warranty against manufacturing defects</li>
                                    <li>Warranty does not cover damage from misuse, accidents, or wear</li>
                                    <li>Warranty claims must include proof of purchase</li>
                                ...
                                <ul>
                                    <li>All content on this website is owned by {siteName}</li>
                                    ...
                                    <li>Product designs are protected by intellectual property laws</li>
                                </ul>
                                ...
                                <ul>
                                    ...
                                    <li>Our total liability is limited to the amount paid for the product</li>
                                    <li>We are not liable for third-party actions or services</li>
                                    <li>We are not liable for force majeure events</li>
                                </ul>
