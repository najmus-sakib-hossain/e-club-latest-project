        ...
        <SiteLayout settings={settings} categories={categories}>
            ...
            <div className="bg-gray-50 py-4">
                <div className="container mx-auto px-4">
                    <div className="flex items-center gap-2 text-sm text-gray-600">
                        ...
                        <ChevronRight className="h-4 w-4" />
                        <span className="text-gray-900 font-medium">Request Callback</span>
                    </div>
                </div>
            </div>
            ...
            <div className="bg-primary/10 py-12">
                <div className="container mx-auto px-4 text-center">
                    ...
                    <h1 className="text-3xl lg:text-4xl font-bold mb-4">Request a Callback</h1>
                    <p className="text-gray-600 max-w-2xl mx-auto">
                        Can't call right now? Leave your number and we'll call you back at your preferred time.
                    </p>
                </div>
            </div>
                    ...
                    <Card>
                        ...
                        <CardContent>
                            <form onSubmit={handleSubmit} className="space-y-4">
                                ...
                                <div className="space-y-2">
                                    <Label htmlFor="preferred_time">Preferred Call Time *</Label>
                                    <Select
                                ...
                                <Button type="submit" className="w-full" disabled={processing}>
                                    ...
                                    {processing ? 'Submitting...' : 'Request Callback'}
                                </Button>
                            </form>
                        </CardContent>
                    </Card>
                            ...
                            <div className="flex items-start gap-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-gray-600 mt-1">
                                        We typically respond to callback requests within 2-4 hours during business hours 
                                        (Saturday - Thursday, 10 AM - 7 PM). Requests submitted outside business hours 
                                        will be addressed on the next working day.
                                    </p>
                                </div>
                            </div>
                        </CardContent>
