            ...
            {values && values.length > 0 ? (
                <div className="relative mx-auto flex max-w-6xl flex-col items-center justify-center gap-8 md:flex-row">
                    ...
                    {values.map((val, idx) => (
                        <motion.div
                            key={val.id}
                            className="group z-10 flex aspect-square w-64 flex-col items-center justify-center rounded-full border-2 border-[#006838] bg-white p-8 text-center shadow-xl transition-colors duration-300 hover:bg-[#006838]"
