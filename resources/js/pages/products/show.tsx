...
import { ChevronRight, Heart, Minus, Plus, Share2, ShoppingCart, Star, Truck, Shield, RotateCcw } from 'lucide-react';
...
export default function ProductShow({ product, relatedProducts, categories, settings }: ProductShowProps) {
                    ...
                    <div className="space-y-6">
                        <div>
                            {product.is_new_arrival && (
                                <Badge className="bg-primary text-primary-foreground mb-2">New Arrival</Badge>
                            )}
                    ...
                    <div className="mt-16">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                            {relatedProducts.map((relatedProduct) => (
                                <Card key={relatedProduct.id} className="group overflow-hidden pt-0">
