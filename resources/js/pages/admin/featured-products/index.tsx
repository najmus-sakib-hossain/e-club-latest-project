...
export default function FeaturedProductsIndex({
    featuredProducts,
    products,
}: Props) {
    ...
    const handleUpdate = (values: FeaturedProductFormValues) => {
        ...
        router.post(
            `/admin/featured-products/${selectedFeatured.id}`,
            formData,
            {
                onSuccess: () => {
                                                ...
                                                (featured) => (
                                                    <TableRow key={featured.id}>
                                                        ...
                                                        <TableCell>
                                                            ...
                                                            <div className="max-w-[150px] truncate text-sm text-muted-foreground sm:max-w-none">
                                                                {
                                                                    featured.subtitle
                                                                }
                                                            </div>
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        ...
                                        <FormControl>
                                            <Input
                                                placeholder="Featured product title"
                                                {...field}
                                            />
                                        </FormControl>
                                        <FormMessage />
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <p>
                                        {selectedFeatured.button_text || 'N/A'}
                                    </p>
                                </div>
                                <div>
                                    <p className="text-sm font-medium text-muted-foreground">
                                    ...
                                    <p className="truncate">
                                        {selectedFeatured.button_link || 'N/A'}
                                    </p>
                                </div>
                            </div>
                        </div>
            ...
            >
                <AlertDialogContent>
                    <AlertDialogHeader>
                        ...
                        <AlertDialogDescription>
                            This will remove "{selectedFeatured?.title}" from
                            the featured products. This action cannot be undone.
                        </AlertDialogDescription>
                    </AlertDialogHeader>
