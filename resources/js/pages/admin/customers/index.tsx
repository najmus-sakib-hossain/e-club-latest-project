            ...
            <div className="flex flex-1 flex-col gap-6 p-6">
                ...
                >
                    ...
                    <Card>
                        ...
                        <CardContent>
                            <div className="text-2xl font-bold">{stats?.avg_orders_per_customer || 0}</div>
                                                ...
                                                >
                                                    ...
                                                    <TableCell className="hidden sm:table-cell">
                                                        <div className="flex items-center gap-2">
                                                            ...
                                                            {customer.email_verified_at && (
                                                                <Badge variant="secondary" className="text-xs hidden lg:inline-flex">Verified</Badge>
                                                            )}
                                                        </div>
                                                    </TableCell>
                                                    ...
                                                    <TableCell className="hidden md:table-cell">
                                                        <span className="font-medium">
                                                            {formatCurrency(customer.orders_sum_total_amount || 0)}
                                                        </span>
                                                    </TableCell>
                                                    <TableCell className="hidden lg:table-cell">
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <p className="text-lg font-semibold">{selectedCustomer.orders_count}</p>
                                </div>
                                <div>
                                    <p className="text-sm font-medium text-muted-foreground">Total Spent</p>
                                    <p className="text-lg font-semibold">
                                        {formatCurrency(selectedCustomer.orders_sum_total_amount || 0)}
                                    </p>
                                </div>
                                <div>
                                ...
                                <div>
                                    ...
                                    <Badge variant={selectedCustomer.email_verified_at ? "default" : "secondary"}>
                                        {selectedCustomer.email_verified_at ? 'Verified' : 'Unverified'}
                                    </Badge>
                                </div>
                            </div>
                        </div>
                ...
                <AlertDialogContent>
                        ...
                        <AlertDialogDescription>
                            ...
                            {selectedCustomer && selectedCustomer.orders_count > 0 && (
                                <span className="block mt-2 text-destructive font-medium">
                                    This customer has {selectedCustomer.orders_count} orders and cannot be deleted.
                                </span>
                            )}
                        </AlertDialogDescription>
                    </AlertDialogHeader>
                    <AlertDialogFooter>
                        ...
                        <AlertDialogAction
                            ...
                            disabled={isDeleting || (selectedCustomer?.orders_count || 0) > 0}
