...
export default function FooterSettings({ settings }: Props) {
    ...
    const parsePaymentMethods = (value: PaymentMethod[] | string | undefined | null): PaymentMethod[] => {
        if (Array.isArray(value)) {
            const parsed = value
                .map((item, index) => {
                    ...
                    const logo = normalizeLogo(item.logo || fallback?.logo || '');
    ...
    useEffect(() => {
        setLogoPreview(settings.site_logo ? `/storage/${settings.site_logo}` : '/logo.png');
    }, [settings.site_logo]);
    ...
    const form = useForm<FooterFormValues>({
        ...
        defaultValues: {
            ...
            footer_copyright_left_link_url: settings.footer_copyright_left_link_url || 'https://realstate.nexgroup.biz',
            footer_copyright_right_text: settings.footer_copyright_right_text || 'Developed and maintained by',
            ...
            social_linkedin: settings.social_linkedin || settings.linkedin || '',
            social_youtube: settings.social_youtube || settings.youtube || '',
            // Section Titles
            footer_follow_us_title: settings.footer_follow_us_title || 'Follow Us',
            footer_quick_links_title: settings.footer_quick_links_title || 'Quick Links',
            footer_customer_service_title: settings.footer_customer_service_title || 'Customer Service',
            footer_information_title: settings.footer_information_title || 'Information',
            footer_payment_title: settings.footer_payment_title || 'Secure Payment Methods',
            // Quick Links Labels
            footer_link_home: settings.footer_link_home || 'Home',
            footer_link_products: settings.footer_link_products || 'All Products',
            footer_link_categories: settings.footer_link_categories || 'Categories',
            ...
            footer_link_order_tracking: settings.footer_link_order_tracking || 'Order Tracking',
            footer_link_wishlist: settings.footer_link_wishlist || 'Wishlist',
            footer_link_shipping: settings.footer_link_shipping || 'Shipping Policy',
            footer_link_returns: settings.footer_link_returns || 'Returns & Exchanges',
            footer_link_faqs: settings.footer_link_faqs || 'FAQs',
            // Information Labels
            footer_link_privacy: settings.footer_link_privacy || 'Privacy Policy',
            footer_link_terms: settings.footer_link_terms || 'Terms & Conditions',
            footer_link_warranty: settings.footer_link_warranty || 'Warranty Information',
            ...
            footer_show_payment_methods: toBool(settings.footer_show_payment_methods),
            footer_show_social_links: toBool(settings.footer_show_social_links),
            // Quick Links URLs
            footer_link_home_url: settings.footer_link_home_url || '/',
            footer_link_products_url: settings.footer_link_products_url || '/products',
            footer_link_categories_url: settings.footer_link_categories_url || '/categories',
            footer_link_about_url: settings.footer_link_about_url || '/about',
            footer_link_contact_url: settings.footer_link_contact_url || '/contact',
            footer_link_help_url: settings.footer_link_help_url || '/help',
            // Customer Service URLs
            footer_link_account_url: settings.footer_link_account_url || '/account',
            footer_link_order_tracking_url: settings.footer_link_order_tracking_url || '/account/orders',
            footer_link_wishlist_url: settings.footer_link_wishlist_url || '/account/wishlist',
            footer_link_shipping_url: settings.footer_link_shipping_url || '/shipping',
            footer_link_returns_url: settings.footer_link_returns_url || '/returns',
            footer_link_faqs_url: settings.footer_link_faqs_url || '/faqs',
            // Information URLs
            footer_link_privacy_url: settings.footer_link_privacy_url || '/privacy',
            footer_link_terms_url: settings.footer_link_terms_url || '/terms',
            footer_link_warranty_url: settings.footer_link_warranty_url || '/warranty',
            footer_link_care_url: settings.footer_link_care_url || '/care',
            footer_link_stores_url: settings.footer_link_stores_url || '/stores',
        },
    });
    ...
    const onSubmit = (values: FooterFormValues) => {
        ...
        formData.append('footer_payment_methods', JSON.stringify(methodsForSave));

        paymentMethods.forEach((method, index) => {
            if (method.file instanceof File) {
                formData.append(`footer_payment_methods_file_${index}`, method.file);
            }
        });
    ...
    const handlePaymentMethodChange = (index: number, field: 'name' | 'logo', value: string) => {
    ...
    const addPaymentMethod = () => {
        setPaymentMethods((prev) => [
            ...prev,
            { id: `payment-${prev.length}`, name: 'New Method', logo: '', file: null },
        ]);
    };
            ...
            <div className="flex flex-1 flex-col gap-6 p-6">
                ...
                >
                    ...
                    <p className="text-muted-foreground">
                        Customize your website footer content, links, contact info, and social media
                    </p>
                </motion.div>
                                    ...
                                    <div className="space-y-4">
                                        <Card>
                                            <CardHeader>
                                                ...
                                                <CardDescription>
                                                    Your store name and description shown in the footer
                                                </CardDescription>
                                            </CardHeader>
                                            <CardContent className="space-y-4">
                                                ...
                                                <FormField
                                                    ...
                                                    render={({ field }) => (
                                                        <FormItem>
                                                            ...
                                                            <FormDescription>
                                                                A brief description about your company shown in the footer
                                                            </FormDescription>
                                                            <FormMessage />
                                                        </FormItem>
                                                    )}
                                                ...
                                                <div className="space-y-4">
                                                    ...
                                                    <FormField
                                                        ...
                                                        render={({ field }) => (
                                                            <FormItem>
                                                                <FormLabel>Copyright Text (Left Side)</FormLabel>
                                                                <FormControl>
                                                                    <Input
                                                                ...
                                                                <FormDescription>
                                                                    The copyright notice displayed on the left side of the footer
                                                                </FormDescription>
                                                                <FormMessage />
                                                            </FormItem>
                                                        )}
                                                        ...
                                                        <FormField
                                                            ...
                                                            render={({ field }) => (
                                                                <FormItem>
                                                                    ...
                                                                    <FormControl>
                                                                        <Input placeholder="Nex Real Estate" {...field} />
                                                                    </FormControl>
                                                                    <FormDescription>
                                                                        Text that will be linked (must appear in copyright text)
                                                                    </FormDescription>
                                                                    <FormMessage />
                                                                </FormItem>
                                                            )}
                                                ...
                                                <div className="space-y-4">
                                                    ...
                                                    <FormField
                                                        ...
                                                        render={({ field }) => (
                                                            <FormItem>
                                                                <FormLabel>Developer Attribution Text</FormLabel>
                                                                <FormControl>
                                                                    <Input
                                                                ...
                                                                <FormDescription>
                                                                    Text shown before the developer link on the right side
                                                                </FormDescription>
                                                                <FormMessage />
                                                            </FormItem>
                                                        )}
                                                        ...
                                                        <FormField
                                                            ...
                                                            render={({ field }) => (
                                                                <FormItem>
                                                                    ...
                                                                    <FormControl>
                                                                        <Input placeholder="Alphainno" {...field} />
                                                                    </FormControl>
                                                                    <FormMessage />
                                                                </FormItem>
                                                            )}
                                        ...
                                        <Card>
                                            <CardHeader>
                                                ...
                                                <CardDescription>Upload or replace the footer logo</CardDescription>
                                            </CardHeader>
                                            <CardContent className="space-y-4">
                                                <div className="flex items-center gap-4">
                                                    <div className="h-16 w-16 rounded border bg-muted/50 flex items-center justify-center overflow-hidden">
                                                        {logoPreview ? (
                                ...
                                <TabsContent value="contact">
                                    <Card>
                                        <CardHeader>
                                            ...
                                            <CardDescription>
                                                Your business contact details displayed in the footer
                                            </CardDescription>
                                        </CardHeader>
                                        <CardContent className="space-y-4">
                                            <div className="grid gap-4 md:grid-cols-2">
                                ...
                                <TabsContent value="social">
                                    <Card>
                                        <CardHeader>
                                            ...
                                            <CardDescription>
                                                Add your social media profile links to display in the footer
                                            </CardDescription>
                                        </CardHeader>
                                        <CardContent className="space-y-4">
                                            <div className="grid gap-4 md:grid-cols-2">
                                ...
                                <TabsContent value="sections">
                                    <Card>
                                        <CardHeader>
                                            ...
                                            <CardDescription>
                                                Customize the heading titles for each section in the footer
                                            </CardDescription>
                                        </CardHeader>
                                        <CardContent className="space-y-4">
                                            <div className="grid gap-4 md:grid-cols-2">
                                                <FormField
                                                    ...
                                                    render={({ field }) => (
                                                        <FormItem>
                                                            <FormLabel>Follow Us Section Title</FormLabel>
                                                            <FormControl>
                                                                <Input placeholder="Follow Us" {...field} />
                                                            </FormControl>
                                                            <FormMessage />
                                                        </FormItem>
                                                    )}
                                                ...
                                                <FormField
                                                    ...
                                                    render={({ field }) => (
                                                        <FormItem>
                                                            <FormLabel>Quick Links Section Title</FormLabel>
                                                            <FormControl>
                                                ...
                                                <FormField
                                                    ...
                                                    render={({ field }) => (
                                                        <FormItem>
                                                            <FormLabel>Customer Service Section Title</FormLabel>
                                                            <FormControl>
                                                ...
                                                <FormField
                                                    ...
                                                    render={({ field }) => (
                                                        <FormItem>
                                                            <FormLabel>Information Section Title</FormLabel>
                                                            <FormControl>
                                                ...
                                                <FormField
                                                    ...
                                                    render={({ field }) => (
                                                        <FormItem className="md:col-span-2">
                                                            <FormLabel>Payment Methods Section Title</FormLabel>
                                                            <FormControl>
                                                                <Input placeholder="Secure Payment Methods" {...field} />
                                                            </FormControl>
                                                            <FormMessage />
                                                        </FormItem>
                                                    )}
                                ...
                                <TabsContent value="visibility">
                                    <Card>
                                        <CardHeader>
                                            ...
                                            <CardDescription>
                                                Control which sections are visible in the footer
                                            </CardDescription>
                                        </CardHeader>
                                        <CardContent className="space-y-6">
                                                ...
                                                render={({ field }) => (
                                                    <FormItem className="flex flex-row items-center justify-between rounded-lg border p-4">
                                                        <div className="space-y-0.5">
                                                            <FormLabel className="text-base">Quick Links Section</FormLabel>
                                                            <FormDescription>
                                                                Show the Quick Links section with Home, Products, Categories, etc.
                                                            </FormDescription>
                                                        </div>
                                                        <FormControl>
                                                            <Switch
                                            ...
                                            <FormField
                                                ...
                                                render={({ field }) => (
                                                    <FormItem className="flex flex-row items-center justify-between rounded-lg border p-4">
                                                        <div className="space-y-0.5">
                                                            <FormLabel className="text-base">Customer Service Section</FormLabel>
                                                            <FormDescription>
                                                                Show the Customer Service section with Account, Orders, Wishlist, etc.
                                                            </FormDescription>
                                                        </div>
                                                        <FormControl>
                                                            <Switch
                                            ...
                                            <FormField
                                                ...
                                                render={({ field }) => (
                                                    <FormItem className="flex flex-row items-center justify-between rounded-lg border p-4">
                                                        <div className="space-y-0.5">
                                                            <FormLabel className="text-base">Information Section</FormLabel>
                                                            <FormDescription>
                                                                Show the Information section with Privacy, Terms, Warranty, etc.
                                                            </FormDescription>
                                                        </div>
                                                        <FormControl>
                                                            <Switch
                                            ...
                                            <FormField
                                                ...
                                                render={({ field }) => (
                                                    <FormItem className="flex flex-row items-center justify-between rounded-lg border p-4">
                                                        <div className="space-y-0.5">
                                                            <FormLabel className="text-base">Payment Methods Section</FormLabel>
                                                            <FormDescription>
                                                                Show the payment method icons (Visa, Mastercard, bKash, etc.)
                                                            </FormDescription>
                                                        </div>
                                                        <FormControl>
                                                            <Switch
                                                ...
                                                render={({ field }) => (
                                                    <FormItem className="flex flex-row items-center justify-between rounded-lg border p-4">
                                                        <div className="space-y-0.5">
                                                            ...
                                                            <FormDescription>
                                                                Show social media icons (Facebook, Instagram, LinkedIn, YouTube)
                                                            </FormDescription>
                                                        </div>
                                                        <FormControl>
                                                            <Switch
                                ...
                                <TabsContent value="payments">
                                    <Card>
                                        <CardHeader>
                                            ...
                                            <CardDescription>
                                                Control the payment logos shown in the footer (title is configured under Section Titles)
                                            </CardDescription>
                                        </CardHeader>
                                        <CardContent className="space-y-4">
                                            <p className="text-sm text-muted-foreground">
                                                Add or update payment gateways. Provide a short name and an image URL; the preview updates instantly.
                                            </p>

                                            <div className="space-y-4">
                                                {paymentMethods.map((method, index) => (
                                                    <div key={method.id || `method-${index}`} className="rounded-lg border p-4 space-y-3">
                                                            ...
                                                            <div>
                                                                ...
                                                                <div className="flex flex-col gap-2">
                                                                    <Input
                                                                        value={method.logo}
                                                                        onChange={(e) =>
                                                                            handlePaymentMethodChange(index, 'logo', e.target.value)
                                                                        }
                                                                    ...
                                                                    <div className="flex items-center gap-2">
                                                                        <input
                                                                            ...
                                                                            onChange={(e) =>
                                                                                handlePaymentFileChange(index, e.target.files?.[0])
                                                                            }
                                                                        />
                                                                        <Button
                                                                            type="button"
                                                                            ...
                                                                            onClick={() =>
                                                                                document
                                                                                    .getElementById(`payment-logo-${index}`)
                                                                                    ?.click()
                                                                            }
                                                                        >
                                                                            <Upload className="mr-2 h-4 w-4" /> Upload Image
                                                                        </Button>
                                                                        <p className="text-xs text-muted-foreground">Upload to replace or set logo</p>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div className="flex items-center gap-3">
                                                            <div className="h-12 w-20 rounded border bg-muted/50 flex items-center justify-center overflow-hidden">
                                                                {method.logo ? (
                                                                    <img
                                                                        src={method.logo}
                                                                        alt={method.name}
                                                            ...
                                                            <p className="text-xs text-muted-foreground">
                                                                Recommended size: 64x32 px, transparent PNG for best results
                                                            </p>
                                                        </div>
                                                    </div>
                                                ))}
                                            ...
                                            <div className="flex justify-between items-center">
                                                ...
                                                <p className="text-xs text-muted-foreground">These appear above the bottom footer text</p>
                                            </div>
                                        </CardContent>
                                    </Card>
                                </TabsContent>
                                ...
                                <TabsContent value="quick-links">
                                    <Card>
                                        <CardHeader>
                                            ...
                                            <CardDescription>
                                                Customize the text labels and URLs for quick navigation links in the footer
                                            </CardDescription>
                                        </CardHeader>
                                        <CardContent className="space-y-6">
                                            {/* Home Link */}
                                            <div className="rounded-lg border p-4 space-y-4">
                                                <h4 className="font-medium">Home Link</h4>
                                                <div className="grid gap-4 md:grid-cols-2">
                                                    <FormField
                                                        control={form.control}
                                            ...
                                            {/* Products Link */}
                                            <div className="rounded-lg border p-4 space-y-4">
                                                <h4 className="font-medium">Products Link</h4>
                                                <div className="grid gap-4 md:grid-cols-2">
                                                    <FormField
                                                        control={form.control}
                                                        ...
                                                        render={({ field }) => (
                                                            <FormItem>
                                                                <FormLabel>Label</FormLabel>
                                                                <FormControl>
                                                                    <Input placeholder="All Products" {...field} />
                                                                </FormControl>
                                                                <FormMessage />
                                                            </FormItem>
                                                        )}
                                            ...
                                            {/* Categories Link */}
                                            <div className="rounded-lg border p-4 space-y-4">
                                                <h4 className="font-medium">Categories Link</h4>
                                                <div className="grid gap-4 md:grid-cols-2">
                                                    <FormField
                                                        control={form.control}
                                ...
                                <TabsContent value="customer-service">
                                    <Card>
                                        <CardHeader>
                                            ...
                                            <CardDescription>
                                                Customize the text labels and URLs for customer service links in the footer
                                            </CardDescription>
                                        </CardHeader>
                                        <CardContent className="space-y-6">
                                            {/* My Account Link */}
                                            <div className="rounded-lg border p-4 space-y-4">
                                                <h4 className="font-medium">My Account Link</h4>
                                                <div className="grid gap-4 md:grid-cols-2">
                                                    <FormField
                                                        control={form.control}
                                            ...
                                            {/* Order Tracking Link */}
                                            <div className="rounded-lg border p-4 space-y-4">
                                                <h4 className="font-medium">Order Tracking Link</h4>
                                                <div className="grid gap-4 md:grid-cols-2">
                                                    <FormField
                                                        control={form.control}
                                                        ...
                                                        render={({ field }) => (
                                                            <FormItem>
                                                                <FormLabel>Label</FormLabel>
                                                                <FormControl>
                                                                    <Input placeholder="Order Tracking" {...field} />
                                                                </FormControl>
                                                                <FormMessage />
                                                            </FormItem>
                                                        )}
                                                    ...
                                                    <FormField
                                                        ...
                                                        render={({ field }) => (
                                                            <FormItem>
                                                                <FormLabel>URL</FormLabel>
                                                                <FormControl>
                                                                    <Input placeholder="/account/orders" {...field} />
                                                                </FormControl>
                                                                <FormMessage />
                                                            </FormItem>
                                                        )}
                                            ...
                                            {/* Wishlist Link */}
                                            <div className="rounded-lg border p-4 space-y-4">
                                                <h4 className="font-medium">Wishlist Link</h4>
                                                <div className="grid gap-4 md:grid-cols-2">
                                                    <FormField
                                                        control={form.control}
                                                    ...
                                                    <FormField
                                                        ...
                                                        render={({ field }) => (
                                                            <FormItem>
                                                                <FormLabel>URL</FormLabel>
                                                                <FormControl>
                                                                    <Input placeholder="/account/wishlist" {...field} />
                                                                </FormControl>
                                                                <FormMessage />
                                                            </FormItem>
                                                        )}
                                            ...
                                            <div className="rounded-lg border p-4 space-y-4">
                                                <h4 className="font-medium">Shipping Policy Link</h4>
                                                <div className="grid gap-4 md:grid-cols-2">
                                                    <FormField
                                                        control={form.control}
                                            ...
                                            <div className="rounded-lg border p-4 space-y-4">
                                                <h4 className="font-medium">Returns & Exchanges Link</h4>
                                                <div className="grid gap-4 md:grid-cols-2">
                                                    <FormField
                                                        control={form.control}
                                                        ...
                                                        render={({ field }) => (
                                                            <FormItem>
                                                                <FormLabel>Label</FormLabel>
                                                                <FormControl>
                                                                    <Input placeholder="Returns & Exchanges" {...field} />
                                                                </FormControl>
                                                                <FormMessage />
                                                            </FormItem>
                                                        )}
                                                    ...
                                                    <FormField
                                                        ...
                                                        render={({ field }) => (
                                                            <FormItem>
                                                                <FormLabel>URL</FormLabel>
                                                                <FormControl>
                                                                    <Input placeholder="/returns" {...field} />
                                                                </FormControl>
                                                                <FormMessage />
                                                            </FormItem>
                                                        )}
                                            ...
                                            {/* FAQs Link */}
                                            <div className="rounded-lg border p-4 space-y-4">
                                                <h4 className="font-medium">FAQs Link</h4>
                                                <div className="grid gap-4 md:grid-cols-2">
                                                    <FormField
                                                        control={form.control}
                                ...
                                <TabsContent value="information">
                                    <Card>
                                        <CardHeader>
                                            ...
                                            <CardDescription>
                                                Customize the text labels and URLs for information/policy links in the footer
                                            </CardDescription>
                                        </CardHeader>
                                        <CardContent className="space-y-6">
                                            {/* Privacy Policy Link */}
                                            <div className="rounded-lg border p-4 space-y-4">
                                                <h4 className="font-medium">Privacy Policy Link</h4>
                                                <div className="grid gap-4 md:grid-cols-2">
                                                    <FormField
                                                        control={form.control}
                                            ...
                                            <div className="rounded-lg border p-4 space-y-4">
                                                <h4 className="font-medium">Terms & Conditions Link</h4>
                                                <div className="grid gap-4 md:grid-cols-2">
                                                    <FormField
                                                        control={form.control}
                                            ...
                                            <div className="rounded-lg border p-4 space-y-4">
                                                <h4 className="font-medium">Warranty Information Link</h4>
                                                <div className="grid gap-4 md:grid-cols-2">
                                                    <FormField
                                                        control={form.control}
                                            ...
                                            <div className="rounded-lg border p-4 space-y-4">
                                                <h4 className="font-medium">Care & Maintenance Link</h4>
                                                <div className="grid gap-4 md:grid-cols-2">
                                                    <FormField
                                                        control={form.control}
                                                        ...
                                                        render={({ field }) => (
                                                            <FormItem>
                                                                <FormLabel>Label</FormLabel>
                                                                <FormControl>
                                                                    <Input placeholder="Care & Maintenance" {...field} />
                                                                </FormControl>
                                                                <FormMessage />
                                                            </FormItem>
                                                        )}
                                            ...
                                            {/* Store Locator Link */}
                                            <div className="rounded-lg border p-4 space-y-4">
                                                <h4 className="font-medium">Store Locator Link</h4>
                                                <div className="grid gap-4 md:grid-cols-2">
                                                    <FormField
                                                        control={form.control}
                                                        ...
                                                        render={({ field }) => (
                                                            <FormItem>
                                                                <FormLabel>Label</FormLabel>
                                                                <FormControl>
                                                                    <Input placeholder="Store Locator" {...field} />
                                                                </FormControl>
                                                                <FormMessage />
                                                            </FormItem>
                                                        )}
                                                    ...
                                                    <FormField
                                                        ...
                                                        render={({ field }) => (
                                                            <FormItem>
                                                                <FormLabel>URL</FormLabel>
                                                                <FormControl>
                                                                    <Input placeholder="/stores" {...field} />
                                                                </FormControl>
                                                                <FormMessage />
                                                            </FormItem>
                                                        )}
