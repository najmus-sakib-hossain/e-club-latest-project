                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    ...
                                    <FormControl>
                                        <Input
                                            placeholder="modern-sofa (auto-generated if empty)"
                                            {...field}
                                        />
                                    </FormControl>
                                    <FormDescription>
                                ...
                                render={({ field }) => (
                                    <FormItem className="flex flex-row items-center justify-between rounded-lg border p-3">
                                        <div className="space-y-0.5">
                                            ...
                                            <FormDescription>
                                                Make this product visible on the
                                                store
                                            </FormDescription>
                                        </div>
                                        <FormControl>
    ...
    return (
        <AdminPageLayout>
            ...
            <motion.div
                ...
                className="@container/main flex flex-1 flex-col gap-2 px-4 py-4 lg:px-6"
            >
                {/* Header */}
                ...
                <Card className="mt-6">
                    ...
                    <CardContent>
                        <div className="-mx-4 overflow-x-auto rounded-md border md:mx-0">
                            <Table>
                                <TableHeader>
                                    <TableRow>
                                    ...
                                    {filteredProducts.length === 0 ? (
                                        ...
                                        filteredProducts.map((product) => (
                                            <TableRow key={product.id}>
                                                <TableCell>
                                                    <div className="h-10 w-10 overflow-hidden rounded-lg bg-gray-100 sm:h-12 sm:w-12">
                                                        {product.images &&
                                                        product.images[0] ? (
                                                            <img
                                                                src={
