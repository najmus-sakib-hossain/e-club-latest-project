                ...
                <div className="container mx-auto px-4">
                    <div className="prose prose-lg mx-auto max-w-4xl">
                        {privacyContent ? (
                            ...
                            <>
                                <p className="lead">
                                    At {siteName}, we are committed to
                                    ...
                                    when you visit our website or make a
                                    purchase.
                                </p>
                                ...
                                <ul>
                                    ...
                                    <li>
                                        Account credentials (username and
                                        password)
                                    </li>
                                ...
                                <ul>
                                    ...
                                    <li>
                                        Send order confirmations and shipping
                                        updates
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                        Send promotional emails (with your
                                        consent)
                                    </li>
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <strong>Business Partners:</strong> With
                                        your consent, for joint marketing
                                        initiatives
                                    </li>
                                    <li>
                                ...
                                <p>
                                    ...
                                    enhance your browsing experience, analyze
                                    site traffic, and personalize content. You
                                    can control cookies through your browser
                                    settings, but disabling them may affect site
                                    functionality.
                                </p>
                                ...
                                <p>
                                    ...
                                    privacy practices of these sites. We
                                ...
                                <p>
                                    ...
                                    with an updated revision date. We encourage
