        ...
        <>
            ...
            <Sheet open={open} onOpenChange={onOpenChange}>
                <SheetContent className="flex flex-col w-full sm:max-w-lg">
                    ...
                    {items.length === 0 ? (
                        <div className="flex-1 flex flex-col items-center justify-center w-[95%] mx-auto">
                        ...
                        <>
                            <ScrollArea className="flex-1 w-[95%] mx-auto">
                            ...
                            {/* Cart Summary */}
                            <div className="border-t py-4 space-y-4 mx-auto w-[90%]">
                                ...
                                <div className="space-y-2">
                                    <Button 
                                        className="w-full bg-primary text-gray-900 hover:bg-primary/90 font-semibold"
                                        size="lg"
                                        asChild
                                    >
