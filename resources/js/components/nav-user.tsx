                ...
                <DropdownMenu>
                    <DropdownMenuTrigger asChild>
                        <SidebarMenuButton
                            size="lg"
                            tooltip={user.name}
                            className={`data-[state=open]:bg-sidebar-accent data-[state=open]:text-sidebar-accent-foreground ${isCollapsed ? 'justify-center border px-0' : ''}`}
                        >
                            <Avatar
                                className={`shrink-0 rounded-lg transition-all duration-200 ${isCollapsed ? 'h-6 w-6' : 'h-8 w-8'}`}
                            >
                                <AvatarImage
                                    src={user.avatar}
                                    alt={user.name}
